            ...
            <section class="cs-services">
                <div class="container container--medium prose prose-lg space-y-8">
                    ...
                    <div
                        ...
                        <div class="grid__column">
                            <div class="cs-services__image">
                                <img src="/images/produce-step-1_1.jpg" class="w-full object-cover" alt="image" />
                            </div>
                        </div>
                    </div>
                    <div
                    ...
                    <div
                        ...
                        <div class="grid__column">
                            <div class="cs-services__image">
                                <img src="/images/produce-step-3_3.jpg" class="w-full object-cover rounded-lg" alt="image" />
                            </div>
                        </div>
                    </div>
                </div>
...
let title = 'Welcome to the KHANG GIA Factory | Where products are made';
let pageDescription = 'Our 3000m² manufacturing facility is a source of pride for KHANG GIA — a place where quality products are created and the lives of hundreds of workers are connected.'
