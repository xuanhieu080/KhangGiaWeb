<template>
    <NuxtLayout name="main">
        <div class="category-page bg-white">
            <div class="md:hidden">
                <img src="/images/all-products/all-banner-1_1.jpg" class="h-full w-full object-contain" alt="Tất cả sản phẩm" />
            </div>
            <div class="hidden md:block">
                <img src="/images/all-products/all-banner-1.jpg" class="h-full w-full object-contain"  alt="Tất cả sản phẩm" />
            </div>
