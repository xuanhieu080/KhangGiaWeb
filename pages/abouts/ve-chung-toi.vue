                    ...
                    <div class="grid lg:grid-cols-2 gap-2 md:gap-6 lg:gap-12">
                        ...
                        <div class="grid__column seven-twelfths mobile--one-whole flex">
                            <div class="cs-about__description flex flex-col justify-center items-center flex-nowrap">
                                ...
                                <p>
                                    Mô hình phát triển bền vững của chúng tôi gói gọn trong 3 chữ KHANG GIA tinh hoa của Gia - An - Khang là một
            ...
            <section class="cs-caption">
                <div class="container container--medium prose prose-lg">
                    <div class="cs-caption__wrapper">
                        ...
                        <span class="cs-caption__author"> Công ty KHANG GIA </span>
                    </div>
                </div>
            </section>
                        ...
                        <div class="grid__column mobile--one-whole my-auto col-span-3">
                            <div class="cs-story__content lg:py-[25px] pl-4 lg:pl-[45px]">
                                ...
                                <div class="ca-story__description">
                                    <p>
                                        Công ty KHANG GIA là ước mơ ấp ủ của những con người vượt khó, nuôi dưỡng ước mơ thương hiệu Việt vươn tầm
                                    ...
                                    <p>
                                        ...
                                        xưởng may gần 3000m2 và hệ thống kho bãi tại Hồ Chí Minh. Công ty KHANG GIA tin rằng chúng tôi có cơ sở về
                        ...
                        <div class="grid__column my-auto">
                            <div class="cs-services__content">
                                ...
                                <div class="cs-services__description">
                                    <p>
                                        Công ty KHANG GIA cam kết những sản phẩm có giá hợp lý và chất lượng cao bởi sự may đo của những người thợ
                                        may giàu kinh nghiệm, cùng chuỗi cung ứng khép kín từ gốc (với ngành may mặc đó là từ sợi, dệt,
                                        nhuộm và may).
                                    </p>
                                    <p>
                                        Ngoài ra mô hình bán hàng trực tiếp (Ecommerce D2C) cho phép KHANG GIA tập trung vào nghiên cứu, sản xuất
                    ...
                    <div id="services2" class="grid lg:grid-cols-2 gap-6 grid--aligned-center grid--two-columns grid--doubling">
                        <div class="grid__column lg:order-2 my-auto">
                            <div class="cs-services__content">
                                ...
                                <div class="cs-services__description">
                                    <p>
                                        Công ty KHANG GIA hoạt động dựa trên một tập thể đoàn kết, chia sẻ và tử tế với nhau để không ngừng xây
                    ...
                    <div id="services4" class="grid lg:grid-cols-2 gap-6 grid--aligned-center grid--two-columns grid--doubling">
                        <div class="grid__column my-auto lg:order-2">
                            <div class="cs-services__content">
                                ...
                                <div class="cs-services__description">
                                    <p>
                                        Công ty KHANG GIA cam kết không chỉ tạo ra giá trị cho cộng đồng và đối tác mà còn bảo vệ và gìn giữ môi
                    ...
                    <div id="services5" class="grid lg:grid-cols-2 gap-6 grid--aligned-center grid--two-columns grid--doubling">
                        <div class="grid__column my-auto">
                            <div class="cs-services__content">
                                ...
                                <div class="cs-services__description">
                                    <p>
                                        Công ty KHANG GIA cam kết hỗ trợ và tạo ra những ảnh hưởng tích cực cho cộng đồng xung quanh thông qua các
