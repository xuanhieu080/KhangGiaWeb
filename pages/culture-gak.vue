    ...
    <NuxtLayout name="main">
        <div class="about-us-image relative">
            ...
            <div
                ...
                <h1 class="font-bold !text-[24px] md:!text-[54px] 2xl:!text-[64px] !my-2">KHANG GIA CULTURE</h1>
                <span class="text-lg xl:text-xl">Everything you wanted to know about KHANG GIA!</span>
            </div>
        ...
        <div class="about-content pt-6 md:!pt-[5rem] mx-auto">
                    ...
                    <div class="grid lg:grid-cols-2 items-center md:gap-12">
                        ...
                        <div class="grid__column seven-twelfths mobile--one-whole">
                            <div class="cs-about__description">
                                <p>
                                    Join us to learn about the culture at KHANG GIA and the goals we are working towards to become better and better.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section class="cs-caption">
                <div class="cs-caption__wrapper w-full">
                    <div class="container container--medium text-white">
                        <div class="grid md:grid-cols-2 gap-4 items-center">
                            <div class="grid-column text-white text-left">
                                <h2 class="cs-caption__heading !mb-0">Culture at KHANG GIA</h2>
                                <p class="max-w-[500px] leading-6 !ml-0">
                                    At KHANG GIA, culture is not merely a set of rules—it is a vibrant spirit and a driving force for every individual in the company. Our culture is deeply embedded in every aspect of our daily operations, from production to customer service, seamlessly blending kindness and integrity across all dimensions.
                                </p>
                            </div>
                        ...
                        <div class="recruitment-culture__ten-facts mt-8 lg:mt-16">
                            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                                <div class="grid__column min-h-[150px]">
                                ...
                                <div class="grid__column min-h-[150px]">
                                    <div class="ten-facts__item">
                                        ...
                                        <div class="ten-facts__description">
                                            Unity and Support: At KHANG GIA, we are a family. We consistently support and encourage one another, fostering a positive work environment built on collective strength and team spirit.
                                        </div>
                                    </div>
                                </div>
                                <div class="grid__column min-h-[150px]">
                                ...
                                <div class="grid__column min-h-[150px]">
                                    <div class="ten-facts__item">
                                        ...
                                        <div class="ten-facts__description">
                                            Social and Environmental Responsibility: We are collectively committed to acting responsibly toward both the community and the environment. At KHANG GIA, our team continually seeks ways to contribute to the sustainable development of society and the nation.
                                        </div>
                                    </div>
                                </div>
                                <div class="grid__column min-h-[150px]">
                                    <div class="ten-facts__item">
                                        ...
                                        <div class="ten-facts__description">
                                            Respect and Integrity: Respect and integrity are core values upheld by every individual at KHANG GIA. We value every relationship and are committed to fairness and honesty in all circumstances.
                                        </div>
                                    </div>
                                </div>
                                <div class="grid__column min-h-[150px]">
            ...
            <div class="recruitment-jobs p-6">
                <div class="container container--medium prose prose-lg">
                    ...
                    <div class="recruitment-jobs__sub-heading text-center text-white font-medium">
                        Join KHANG GIA to go further and more sustainably<br />Find out about our latest job openings!
                    </div>
                    <div class="recruitment-job__swiper w-full mt-8 mb-4 relative">
                        ...
                        <Swiper
                            ...
                            class="swiper diary-swiper min-w-0 md:!hidden relative z-10 !pb-14">
                            <SwiperSlide v-for="job in jobsMobile" :key="'mob-' + job.title" class="recruitment-jobs-slide">
                                <CultureJobItem v-bind="job" />
                            </SwiperSlide>
                        </Swiper>
                        <!-- Desktop Swiper -->
                        <Swiper
                            ...
                            class="swiper diary-swiper min-w-0 h-[580px] !hidden md:!block relative z-10 !pb-14">
                            <SwiperSlide v-for="job in jobsDesktop" :key="'desk-' + job.title" class="recruitment-jobs-slide">
                                <CultureJobItem v-bind="job" />
                            </SwiperSlide>
                        </Swiper>
                    </div>
            ...
            <section class="recruitment-send">
                <div class="container container--medium prose prose-lg flex flex-col">
                    <h2 class="recruitment-send__heading">Thank you for choosing KHANG GIA company.</h2>
                    <p class="recruitment-send__description">
                        If the open positions are not suitable for you, but you want to fulfill your big dreams with KHANG GIA, please feel free to send your CV to KHANG GIA. The HR department will contact you soon!
                    </p>
                    <UButton
                        variant="ghost"
                        color="none"
                ...
                <div class="container container--medium">
                    ...
                    <div class="grid lg:grid-cols-2 gap-4">
                        <div class="grid__column">
                            <div class="recruitment-blogs__left">
                                <h3 class="recruitment-blogs__title">Tin tức mới</h3>
                                <div
                                    rel-script="blogs-listing"
                                    data-cat-id="61d4159419f5db2b5a398f95"
                                    data-type="grid"
                                    class="recruitment-blogs__listings">
                                    <div class="grid lg:grid-cols-2 gap-4 grid--two-columns pb-12">
                                        <div class="grid__column">
                                            <div class="recruitment-blog-grid">
                                                ...
                                                <div class="recruitment-blog-grid__content">
                                                    <div class="recruitment-blog-grid__meta">
                                    ...
                                    <div class="grid gap-4 pb-12">
                                        <div class="grid__column">
                                            <div class="recruitment-blog-item">
                                                ...
                                                <div class="recruitment-blog-item__content">
                                                    <div class="recruitment-blog-item__meta">
                                                    ...
                                                    <a
                                                        href="https://drive.google.com/file/d/1bQl3u2YO_ARp4LIx5l_MgYyvhQxFnzjE/view?usp=drive_link"
                                                        target="_blank"
                                                        class="recruitment-blog-item__button"
                                                        >Tải tài liệu</a
                                                    >
                                                </div>
                                            </div>
                                            ...
                                            <div class="recruitment-blog-item">
                                                ...
                                                <div class="recruitment-blog-item__content">
                                                    ...
                                                    <p class="recruitment-blog-item__description">
                                                        ...
                                                        tháng đầu tiên của năm 2024 cùng Bản tin tháng 01 nhé!
                                                    </p>
                                                    <a
                                                        href="https://drive.google.com/file/d/1zjeGz0LpuodWxgVjEaePP_u7YwtU3oKe/view?usp=sharing"
                                                        target="_blank"
                                                        class="recruitment-blog-item__button"
                                                        >Tải tài liệu</a
                                                    >
                                            ...
                                            <div class="recruitment-blog-item">
                                                ...
                                                <div class="recruitment-blog-item__content">
                                                    ...
                                                    <p class="recruitment-blog-item__description">
                                                        ...
                                                        nhiều chương trình, hoạt động cũng như kết quả đặc biệt. Cùng nhìn lại tháng 12 cũng
                                                        như một số tổng kết cho năm 2023 qua bản tin dưới đây nhé!
                                                    </p>
                                                    <a
                                                        href="https://drive.google.com/file/d/1YC21sw3oQslxl2cTWFjp7fK67eJQd1kG/view?usp=drive_link"
                                                        target="_blank"
                                                        class="recruitment-blog-item__button"
                                                        >Tải tài liệu</a
                                                    >
                                        ...
                                        <div class="grid__column">
                                            <div class="recruitment-blog-item">
                                                ...
                                                <div class="recruitment-blog-item__content">
                                                    ...
                                                    <a
                                                        href="https://drive.google.com/file/d/1jeicoXebz5JLenE7wEYBd76EuozHgEBL/view?usp=sharing"
                                                        target="_blank"
                                                        class="recruitment-blog-item__button"
                                                        >Tải tài liệu</a
                                                    >
            ...
            <section class="recruitment-connect">
                <div class="container container--medium">
            ...
            <section class="recruitment-social">
                <div class="container container--medium">
                    <div class="grid grid-cols-3 items-center">
                        <div class="grid__column three-twelfths mobile--one-half">
                            <div class="recruitment-social__item">
...
let modules = ref([Navigation, Pagination, Grid]);
...
// Dữ liệu jobs — tách ra để tránh lặp lại HTML hàng trăm dòng
const jobsMobile = [
    ...
    { title: 'Design Specialist' },
    { title: 'Tuyển dụng thợ may' },
    { title: 'SEO Specialist' },
    { title: 'Warehouse staff' },
    { title: 'Product Photographer' },
    { title: 'Senior Advertising Operator' },
];
...
let title = 'KHANG GIA Company Culture';
...
.about-content {
    ...
    .cs-caption__wrapper {
        ...
        .recruitment-culture__ten-facts {
            .ten-facts__item {
    ...
    .recruitment-blogs {
        padding-top: 50px;
        .recruitment-blogs__heading {
            text-align: center;
            margin-bottom: 35px;
            font-size: 2.25rem;
        }
        .recruitment-blogs__left,
        .recruitment-blogs__right {
            padding: 45px 6px 0 66px;
            border-radius: 50px;
            background-color: #2f5acf;
            height: 100%;
            overflow: hidden;
            .recruitment-blogs__title {
                font-size: 18px;
                line-height: 27px;
                font-weight: 600;
                margin-bottom: 20px;
            ...
            .recruitment-blogs__listings {
                max-height: 780px;
                overflow-y: auto;
                overflow-x: hidden;
                padding-right: 50px;
                -webkit-overflow-scrolling: touch;
                .recruitment-blog-grid {
                    display: flex;
                    flex-flow: column;
                    border-radius: 15px;
                    ...
                    overflow: hidden;
                    height: 100%;
                    .recruitment-blog-grid__content {
                        display: flex;
                        flex-flow: column;
                        padding: 15px 20px;
                        height: 100%;
                        .recruitment-blog-grid__meta {
                            display: flex;
        ...
        .recruitment-blogs__right {
            ...
            .recruitment-blog-item {
                display: flex;
                border-radius: 15px;
                background: #fff;
                overflow: hidden;
                .recruitment-blog-item__image {
                    width: 195px;
                    height: 100%;
                    img {
                        height: 100%;
                ...
                .recruitment-blog-item__content {
                    padding: 25px 20px;
                }
                .recruitment-blog-item__meta {
                    display: flex;
                    justify-content: space-between;
                    color: #6e798c;
                    font-size: 11px;
    ...
    .recruitment-social {
        .recruitment-social__item {
            display: flex;
            align-items: center;
            justify-content: center;
            padding: 16px;
            font-size: 14px;
            .recruitment-social__icon {
                width: 37px;
                height: 37px;
                margin-right: 10px;
            }
            .recruitment-social__link {
    ...
    .recruitment-jobs {
        background-color: #2f5acf;
        .recruitment-jobs__heading {
            text-align: center;
            color: #ffffff;
            text-transform: initial;
        }
        .recruitment-job__swiper {
            .recruitment-jobs-slide {
                text-align: center;
                font-size: 18px;
                padding-left: 40px;
                padding-right: 50px;
                ...
                .job-item {
                    ...
                    .job-grid__content {
                        ...
                        .job-grid__description {
                            margin: 0 0 24px;
                            font-size: 14px;
                            color: #000;
                            line-height: 20px;
                        }
                        .job-grid__description + ul li {
                            display: flex;
                            align-items: center;
                            background-color: #f1f1f1;
                            padding: 0 20px;
